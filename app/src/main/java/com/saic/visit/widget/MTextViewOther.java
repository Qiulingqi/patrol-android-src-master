 ...
 */
public class MTextViewOther extends TextView {
    private Context context;
    public MTextViewOther(Context context) {
        super(context);
        this.context = context;
    }

    public MTextViewOther(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        this.context = context;
    }

    public MTextViewOther(Context context, AttributeSet attrs) {
        super(context, attrs);
        this.context = context;
    }
