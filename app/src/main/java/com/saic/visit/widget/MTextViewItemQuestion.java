 ...
 */
public class MTextViewItemQuestion extends TextView {
    private Context context;
    public MTextViewItemQuestion(Context context) {
        super(context);
        this.context = context;
    }

    public MTextViewItemQuestion(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        this.context = context;
    }

    public MTextViewItemQuestion(Context context, AttributeSet attrs) {
        super(context, attrs);
        this.context = context;
    }
    ...
    private float getMaxLineHeight(String str) {
        ...
        float paddingReft = ViewUtil.dpToPx(36, context);
