...
import com.library.ui.utils.LogUtils;
...
public class FileTool {
    ...
    public static void mkdir(String dir) {
        try {
            ...
            LogUtils.e("文件操作", "创建目录操作出错: " + e.getMessage());
            e.printStackTrace();
        }
    }
     ...
     * @param dir 目录
     */
    public static boolean judgeDir(String dir) {
        try {
            String dirTemp = dir;
            File dirPath = new File(dirTemp);
            if (dirPath.exists()) {
    ...
    public static void createNewFile(String fileName, String content) {
        try {
            ...
            LogUtils.e("文件操作", "新建文件操作出错: " + e.getMessage());
            e.printStackTrace();
        }
    ...
    public static void delFile(String fileName) {
        try {
            ...
            LogUtils.e("文件操作", "删除文件操作出错: " + e.getMessage());
            e.printStackTrace();
        }
    }
    ...
    public static boolean delFolder(String folderPath) {
        try {
            ...
            LogUtils.e("文件操作", "删除文件夹操作出错" + e.getMessage());
            e.printStackTrace();
            return false;
        }
    }
    ...
    public static void copyFile(String srcFile, String dirDest) {
        try {
            ...
            LogUtils.e("文件操作", "复制文件操作出错:" + e.getMessage());
            e.printStackTrace();
        }
    }
    ...
    public static void copyFolder(String oldPath, String newPath) {
        try {
            ...
            LogUtils.e("文件操作", "复制文件夹操作出错:" + e.getMessage());
            e.printStackTrace();
        }
    }
    ...
    public static String getDataDirectory(){
        try {
            String path =  Environment.getDataDirectory().getAbsolutePath();//获取 Android 数据目录
            return  path;
        }catch (Exception e){
            e.printStackTrace();
        }
